            ...
            <div class="widget-body no-padding">
              ...
              <div class="widget-separator grid-4">
                ...
                <select class="form form-full" name="processor">
                  <option selected="selected" value="${Processor}">${Processor}</option>
              ...
              <div class="widget-separator grid-12 c-r-p">
                ...
                <h5 class="typo inline">yes</h5><div class="radio"><span><input name="bluetooth" value="yes" checked="${bluetooth}" type="radio" class="uniform"></span></div>
              	<h5 class="typo inline">no</h5><div class="radio"><span><input name="bluetooth" value="no" checked="${bluetooth}" type="radio" class="uniform"></span></div>
              </div>
              <div class="widget-separator grid-12 c-r-p">
                <h5 class="typo">${name2}</h5>
                <h5 class="typo inline">yes</h5><div class="radio"><span><input name="wifi"  value="yes"  type="radio" checked="${wifi}" class="uniform"></span></div>
              	<h5 class="typo inline">no</h5><div class="radio"><span><input name="wifi" value="no" type="radio" checked="${wifi}" class="uniform"></span></div>
              </div>
              <div class="widget-separator grid-12">
