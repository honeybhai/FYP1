  ...
  <div class="container">
    ...
    <div class="contents">
      ...
      <header class="header grid-12">
        ...
        <div class="top-user grid-4">
          ...
          <div class="user-data">
         	<c:if test='${empty sessionScope["userId"]}' >
				...
				<h4><a href="${pageContext.request.contextPath}/signUp.bnu">SignUp</a></h4>
				<h6>Visitor</h6>
                ...
                <div id="u-s-icon" class="btn btn-menu btn-small btn-transparent btn-o-icon"><i>&#xf013;</i>
                  ...
                  <div class="menu menu-bottom-right">
                    <ul>
                      ...
                      <li>
                        <c:if test='${empty sessionScope["userId"]}' >
							<h4><a href="${pageContext.request.contextPath}/login.bnu"><div class="menu-icon"><!-- Empty --></div>
                        	  <div class="menu-title">
                        	    Login
                         	  </div>
							</a></h4>
        ...
        <!-- Popular Page -->
        <c:if test='${empty sessionScope["userId"]}' >
			<div class="top-buttons grid-12" style="display: none;">
		</c:if>
		<c:if test='${not empty sessionScope["userId"]}' >
          ...
          <div class="grid-2">
            <a href="${pageContext.request.contextPath}/viewSellerProfile.bnu">
          ...
          <div class="grid-2">
            <a href="${pageContext.request.contextPath}/viewProducts.bnu">
              <div class="data-icon" style="color: #95CFB7;">&#xf07a;</div>
              <div class="data-info">
                <h4>Ads</h4>
                <h5><span class="s-up">&#xf0d8; 23%</span>New Sales</h5>
              </div>
            </a>
          </div>
          <div class="grid-2">
            <a href="${pageContext.request.contextPath}/addNewProduct.bnu">
              ...
              <div class="data-info">
                <h4>Block List</h4>
                <h5><span class="i-stars">&#xf005;</span> New Product</h5>
              </div>
            </a>
          </div>
          <div class="grid-2">
